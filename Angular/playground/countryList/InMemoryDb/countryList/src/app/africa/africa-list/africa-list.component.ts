...
@Component({
  selector: 'app-africa-list',
  templateUrl: './africa-list.component.html',
  styleUrls: ['./africa-list.component.less']
})
export class AfricaListComponent implements OnInit {
  pageTitle = 'Africa Country List';
