...
@Component({
  selector: 'app-oceania-list',
  templateUrl: './oceania-list.component.html',
  styleUrls: ['./oceania-list.component.less']
})
export class OceaniaListComponent implements OnInit {
  pageTitle = 'Oceania Country List';
